...
![](assets/用户和组权限管理/file-20251119093408969.png)
...
*   **了解：** Linux 系统中的 `cmask` 和 `umask` 的默认值
	 ![](assets/用户和组权限管理/file-20251119093502084.png)
    ![](assets/用户和组权限管理/file-20251119093504581.png)

*   **了解：** UNIX 初始权限的生成机制
     
![](assets/用户和组权限管理/file-20251119093522480.png)


**权限管理：`chmod`**

![](assets/用户和组权限管理/file-20251119093533709.png)
...
![](assets/用户和组权限管理/file-20251119093545557.png)

![](assets/用户和组权限管理/file-20251119093552908.png)
...
**常用命令：**
![](assets/用户和组权限管理/file-20251119093640473.png)
...
| ---- | ------------------------------------- |
| 命令选项 |                                       |
| -a   | 列出：<目录>中所有的<文件和子目录>的隐藏属性(保护隐藏文件和隐藏目录) |
| -d   | 仅显示：<目录>自身的<隐藏属性>                     |
| =R   | 执行：递归操作<针对目录有效>                       |
...
![](assets/用户和组权限管理/file-20251119093657793.png)
```bash
# 追加属性（a：仅追加写入）
chattr +a logfile
